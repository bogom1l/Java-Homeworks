...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i < people.length; i++) {
            if (personToSearch.getId() == people[i].getId())
                count++;
        }
        System.out.println("The person searched for is written " + count + " time(s) in the array");
        //Грешката беше че цикъла започва от първият включително, а то него търсим така че трябва да почнем от вторият тоест i=1;
        ...
        System.out.println("The average age of the people in the array is " + (int)averageAge);

        //Трябва да НЕ съдържа ид-то, тоест да провери на всеки уникален възрастта
        //Трябва възрастта да е INT.
    }
}
